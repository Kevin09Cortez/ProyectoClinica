...
public class Persona {
     ...
     public static void main(String[] arg)
    {
        ...
        dato = Integer.parseInt(JOptionPane.showInputDialog("Digite la edad a buscar: "));
        int i=0;
        ...
        if (respuesta == false)
        {
            JOptionPane.showMessageDialog(null, "La edad no se encuentra dentro del arreglo.");
        }
        else
        {
            JOptionPane.showMessageDialog(null, "La edad se encuentra dentro del arreglo.");
        }
    }
}
